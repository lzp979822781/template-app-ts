...
/******/ 	deferredModules.push(["./src/pages/ReferPage/index.tsx","common"]);
...
/***/ "./src/pages/ReferPage/index.scss":
/*!****************************************!*\
  !*** ./src/pages/ReferPage/index.scss ***!
  \****************************************/
...
__webpack_require__(/*! ./index.scss */ "./src/pages/ReferPage/index.scss");
  ...
  _createClass(PagePicker, [{
    ...
    value: function renderItems() {
      ...
      return dataSource.map(function (item, index) {
        var boolen = value === "参照-" + item;
        var className = boolen ? "item-title-select" : "item-title";
        return _react2.default.createElement(
          _componentsRn.View,
          { hoverClass: 'list-item-hover', hoverStyle: {
